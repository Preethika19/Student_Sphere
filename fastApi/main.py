...
@app.put("/student/update-address")
async def updateStudentAddress( student_id : int, door_no : str, street : str, city : str) :
    return db.updateStudentAddress(student_id, door_no, street, city, connection);
